...
router.all('/trackss', middleware.supportedMethods('GET, POST, OPTIONS'));
//list tracks
...
// router.post('/trackss/:name', function(req, res, next) {
//   console.log('======================')
//     pubsub.emit('player.changet', req.params.name);
