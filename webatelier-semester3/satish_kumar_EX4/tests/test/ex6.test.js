  ...
  it('should work for simple ...', function(done){
    request(baseURL)
      ...
      .end(function(err, res){
        ...
        var expectedCloud = fs.readFileSync(path.resolve(__dirname,'fixtures/expected_cloud-simple.txt'), 'utf8');
        var terms = expectedCloud.split(" ");
  ...
  it('should work for turing ...', function(done){
    request(baseURL)
      ...
      .end(function(err, res){
        ...
        var expectedCloud = fs.readFileSync(path.resolve(__dirname,'fixtures/expected_cloud-turing.txt'), 'utf8');
        var terms = expectedCloud.split(" ");
